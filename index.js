...
var createServer = function createServer(e, opts) {
  ...
  server.on('request', function (request, response) {
    ...
    var toPlaylist = function toPlaylist() {
      var toEntry = function toEntry(file, i) {
...
var macflix = function macflix(torrent, opts) {
  if (!opts) {
    opts = {};
  }
